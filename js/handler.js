...
const textos = {
    pt: {
        ...
        tartaruga_cometa: `Sistema de gerenciamento de entregas desenvolvido com Java Web, Servlets, JSP e PostgreSQL, com foco em regras de negócio e organização. Acesse o repositório <a href="https://github.com/alvarofgomes/TartarugaCometa" target="_blank" style="color:#ccc; text-decoration:none;">aqui</a> e veja o vídeo no <a href="https://www.linkedin.com/posts/alvarofgomes_projeto-em-desenvolvimento-sistema-de-activity-7412247750647463937-D_Xp" target="_blank" style="color:#ccc; text-decoration:none;">LinkedIn</a>.`,
        fx_calc: `Calculadora com interface gráfica criada em JavaFX, explorando layouts (VBox, GridPane), eventos de mouse e estilização com CSS. Acesse o repositório <a href="https://lnkd.in/dnsV6_js" target="_blank" style="color:#ccc; text-decoration:none;">aqui</a> e veja o vídeo no <a href="https://www.linkedin.com/posts/alvarofgomes_praticando-javafx-na-pr%C3%A1tica-hoje-dediquei-activity-7421207745980182528-sLzr" target="_blank" style="color:#ccc; text-decoration:none;">LinkedIn</a>.`,
        fx_crono: `Cronômetro com interface gráfica desenvolvido em JavaFX, utilizando Timeline, KeyFrame, eventos de botões e organização com VBox e HBox. Acesse o repositório <a href="https://lnkd.in/dnsV6_js" target="_blank" style="color:#ccc; text-decoration:none;">aqui</a> e veja o vídeo no <a href="https://www.linkedin.com/posts/alvarofgomes_praticando-javafx-na-pr%C3%A1tica-criando-um-activity-7428860959399632896-c1Ju" target="_blank" style="color:#ccc; text-decoration:none;">LinkedIn</a>.`,
        fx_quiz: `Quiz interativo com interface gráfica em JavaFX, explorando RadioButton, ToggleGroup, controle de fluxo entre perguntas e lógica de pontuação. Acesse o repositório <a href="https://lnkd.in/dnsV6_js" target="_blank" style="color:#ccc; text-decoration:none;">aqui</a> e veja o vídeo no <a href="https://www.linkedin.com/posts/alvarofgomes_praticando-javafx-na-pr%C3%A1tica-criando-um-activity-7429215696657473538-qVgf" target="_blank" style="color:#ccc; text-decoration:none;">LinkedIn</a>.`,
        open_pdf: "Abrir PDF",
    ...
    en: {
        ...
        tartaruga_cometa: `Delivery management system built with Java Web, Servlets, JSP and PostgreSQL, focused on business rules and data integrity. Access the repository <a href="https://github.com/alvarofgomes/TartarugaCometa" target="_blank" style="color:#ccc; text-decoration:none;">here</a> and watch the video on <a href="https://www.linkedin.com/posts/alvarofgomes_projeto-em-desenvolvimento-sistema-de-activity-7412247750647463937-D_Xp" target="_blank" style="color:#ccc; text-decoration:none;">LinkedIn</a>.`,
        fx_calc: `Calculator with a graphical interface built in JavaFX, exploring layouts (VBox, GridPane), mouse events and CSS styling. Access the repository <a href="https://lnkd.in/dnsV6_js" target="_blank" style="color:#ccc; text-decoration:none;">here</a> and watch the video on <a href="https://www.linkedin.com/posts/alvarofgomes_praticando-javafx-na-pr%C3%A1tica-hoje-dediquei-activity-7421207745980182528-sLzr" target="_blank" style="color:#ccc; text-decoration:none;">LinkedIn</a>.`,
        fx_crono: `Stopwatch with a graphical interface built in JavaFX, using Timeline, KeyFrame, button events and layout organization with VBox and HBox. Access the repository <a href="https://lnkd.in/dnsV6_js" target="_blank" style="color:#ccc; text-decoration:none;">here</a> and watch the video on <a href="https://www.linkedin.com/posts/alvarofgomes_praticando-javafx-na-pr%C3%A1tica-criando-um-activity-7428860959399632896-c1Ju" target="_blank" style="color:#ccc; text-decoration:none;">LinkedIn</a>.`,
        fx_quiz: `Interactive quiz with a graphical interface in JavaFX, exploring RadioButton, ToggleGroup, question flow control and scoring logic. Access the repository <a href="https://lnkd.in/dnsV6_js" target="_blank" style="color:#ccc; text-decoration:none;">here</a> and watch the video on <a href="https://www.linkedin.com/posts/alvarofgomes_praticando-javafx-na-pr%C3%A1tica-criando-um-activity-7429215696657473538-qVgf" target="_blank" style="color:#ccc; text-decoration:none;">LinkedIn</a>.`,
        open_pdf: "Open PDF",
...
function UpdateLanguage(idioma) {
    ...
    document.getElementById("experience_menu").textContent = textos[idioma].experience_menu;
    ...
    document.getElementById("experience_title").textContent = textos[idioma].experience_title;
    ...
    document.getElementById("tartaruga_cometa").innerHTML = textos[idioma].tartaruga_cometa;
    document.getElementById("fx_calc").innerHTML = textos[idioma].fx_calc;
    document.getElementById("fx_crono").innerHTML = textos[idioma].fx_crono;
    document.getElementById("fx_quiz").innerHTML = textos[idioma].fx_quiz;
