...
export const categorias: Record<CategoriaKey, Categoria> = {
  todos: {
    ...
    cor: "linear-gradient(135deg, #2A6FDB, #8B5CF6)"
  },
  java: {
  ...
  web: {
    ...
    icon: "fas fa-code",
    cor: "linear-gradient(135deg, #e44d26, #2A6FDB)"
  },
  git: {
    label: { pt: "Git & GitHub", en: "Git & GitHub" },
    icon: "fab fa-git-alt",
    cor: "linear-gradient(135deg, #f05032, #2d333b)"
  },
  ia: {
  ...
  sql: {
    ...
    cor: "linear-gradient(135deg, #336791, #00758f)"
  },
  outros: {
    label: { pt: "Bootcamps", en: "Bootcamps" },
    icon: "fas fa-graduation-cap",
    cor: "linear-gradient(135deg, #1da5bd, #4b5563)"
  }
};
